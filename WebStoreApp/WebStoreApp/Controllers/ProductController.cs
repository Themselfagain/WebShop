...
namespace WebStoreApp.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            updatedProduct.Categories = _categoryService.GetCategories().Select(b=>new CategoryPairVM() 
            {
            Id = b.Id,
            Name =b.CategoryName
            }).ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, ProductEditVM collection)
        {
            if (ModelState.IsValid)
            {
                var updated = _productService.Update(id, collection.ProductName, collection.BrandId, collection.CategoryId, collection.Picture, collection.Quantity, collection.Price, collection.Discount);
                if (updated)
                {
